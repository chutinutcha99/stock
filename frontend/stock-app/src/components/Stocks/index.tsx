...
import { Stock } from "@/types/stockPackage";
import ButtonDefault from "../Buttons/ButtonDefault";

const stockData: Stock[] = [
    {
       image: "/images/stock/stock-01.png",
       itemcode: 100001,
       name: "Apple Watch",
       brandname: "Apple",
       typepro: "Electronics",
                    ...
                    <table className="w-full table-auto">
                        ...
                        <tbody>
                            {stockData.map((stockItem, index) => (
                                <tr key={index}>
                                    <td className ={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7.5 ${index === stockData.length - 1 ? "border-b-0" : "border-b"} flex justify-center items-center`}>
                                        <Image
                                        src={stockItem.image}
                                        width={60}
                                        height={50}
                                    ...
                                    <td className="text-body-sm text-center font-medium text-dark dark:text-dark-6">
                                        {stockItem.itemcode}
                                    </td>
                                    <td className="text-body-sm text-center font-medium text-dark dark:text-dark-6">
                                        {stockItem.name}
                                    ...
                                    <td
                                        className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pr-7.5 ${index === stockData.length - 1 ? "border-b-0" : "border-b"}`}
                                        >
