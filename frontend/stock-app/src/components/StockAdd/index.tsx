...
import createStock from "@/services/api/createStock";

export const metadata: Metadata = {
  title: "Add Data Form",
  description: "This is Add Data Form",
};
...
const StockAdd = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isChecked) {
      setMessage("โปรดยืนยันการทำรายการ");
      setLoading(false);
      return;
    }
      ...
      <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
        <form onSubmit={handleSubmit}>
          <div className="p-6.5">
            ...
            >
              {loading ? "Submitting..." : "Submit"}บันทึก
            </button>
          </div>
        </form>
        {message && <p>{message}</p>}
