                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="fullName"
                        id="fullName"
                        placeholder="กรอกชื่อ และนามสกุล"
                        defaultValue="กรอกชื่อ และนามสกุล"
                      />
                    </div>
                  </div>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      defaultValue="กรอกชื่อผู้ใช้งาน"
                    />
                  </div>
                </div>
